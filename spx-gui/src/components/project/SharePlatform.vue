    ...
    <div class="social-icons">
      ...
      >
        <div class="icon-wrapper">
          <img v-if="platform.name === 'qq'" :src="qqIcon" class="icon" alt="QQ" />
          <img v-else-if="platform.name === 'wechat'" :src="wechatIcon" class="icon" alt="WeChat" />
          <img v-else-if="platform.name === 'douyin'" :src="douyinIcon" class="icon" alt="Douyin" />
          <img v-else-if="platform.name === 'xiaohongshu'" :src="xiaohongshuIcon" class="icon" alt="Xiaohongshu" />
          <img v-else-if="platform.name === 'bilibili'" :src="bilibiliIcon" class="icon" alt="Bilibili" />
        </div>

...
export function getMockVideos(owner: string = 'demo_user'): VideoData[] {
  return [
    {
      id: '1',
      ...
      videoUrl: 'https://example.com/videos/intro-tutorial.mp4',
    ...
    },
    {
      ...
      videoUrl: 'https://example.com/videos/sprite-animation.mp4',
    ...
    },
    {
      ...
      videoUrl: 'https://example.com/videos/game-logic.mp4',
    ...
    },
    {
      ...
      videoUrl: 'https://example.com/videos/sharing-tips.mp4',

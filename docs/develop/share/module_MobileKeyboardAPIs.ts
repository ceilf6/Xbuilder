import type { FileCollection, Visibility } from '../../../spx-gui/src/apis/common/index.ts'
...
export interface ProjectService {
    ...
    addProject(params: AddProjectParams | AddProjectByRemixParams, signal?: AbortSignal): Promise<ProjectData>
    
    /** Get a specific project */
    getProject(owner: string, name: string, signal?: AbortSignal): Promise<ProjectData>
    
    /** Update an existing project */
    updateProject(owner: string, name: string, params: UpdateProjectParams, signal?: AbortSignal): Promise<ProjectData>
